...
const data = [
  ...
  { id: 2, txt: 'Decoration', isChecked: false },
  { id: 3, txt: 'Entertainment show', isChecked: false },
  { id: 4, txt: 'Food and Drinks', isChecked: false },
  { id: 5, txt: 'Event Photography', isChecked: false },
...
export default Aniversary = () => {
  ...
  const getData = async () => {
   setEvent(await AsyncStorage.getItem("event"))
